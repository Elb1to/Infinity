...
public abstract class Menu {
    ...
    private Button placeholderButton = Button.placeholder(this.plugin.getPlaceholderGlass());
    ...
    public void openMenu(final Player player) {
        ...
        if (this.autoUpdate && this.task == null) {
            this.task = this.plugin.getServer().getScheduler().runTaskTimer(this.plugin, () -> this.openMenu(player), 0, 20L);
        }
    }
